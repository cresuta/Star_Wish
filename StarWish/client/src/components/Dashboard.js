...
export const Dashboard = () => {
  return (
    <>
      <SearchForm />
      <Carousel>
        <Carousel.Item className="dashboard-ad1" interval={3000}>
            <img
            ...
            <Carousel.Caption className="ad-text">
              <h3 className="ad-text-heading">Your one-stop shop for great deals</h3>
        ...
        <Carousel.Item className="dashboard-ad2" interval={3000}>
          <img
        ...
        <Carousel.Item className="dashboard-ad3" interval={3000}>
          <img
          ...
          <Carousel.Caption className="ad-text3">
            <h3 className="ad-text-heading">Extra 15% off top Robot Vacuums, direct from the brand</h3>
            <p className="ad-text-content">Save even more for a limited time. Plus, free shipping.</p>
            <Button variant="dark">
              Get the coupon<i class="bi bi-arrow-right"></i>
            </Button>{" "}
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item className="dashboard-ad4" interval={3000}>
          <img
          ...
          <Carousel.Caption className="ad-text4">
            <h3 className="ad-text-heading">The right parts at the right prices</h3>
            <p className="ad-text-content">Everything you need for your vehicle.</p>
            <Button variant="dark">
